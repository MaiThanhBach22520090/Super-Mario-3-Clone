...
#include "AssetIDs.h"
#include "../05-SceneManager/AssetIDs.h"
...
// DEFINES FOR MAIN TEXTURES
#define TEXTURE_PATH_STAGE_TILES TEXTURES_DIR "\\NES - Super Mario Bros 3 - Stage Tiles.png"
#define TEXTURE_PATH_ENEMIES TEXTURES_DIR "\\NES - Super Mario Bros 3 - Enemies.png"
...
void LoadAssetsStar()
{
	...
	CAnimations* animations = CAnimations::GetInstance();
	LPTEXTURE texMisc = textures->Get(ID_TEX_MISC);
	sprites->Add(ID_SPRITE_STAR + 1, 372, 189, 372 + 15, 189 + 15, texMisc);
	LPANIMATION ani = new CAnimation(100);
...
// LOAD MAIN ASSETS
void LoadAssetsGroundTop()
{
	CTextures* textures = CTextures::GetInstance();
	CSprites* sprites = CSprites::GetInstance();
	LPTEXTURE texMisc = textures->Get(ID_TEX_MISC);
	sprites->Add(ID_SPRITE_GROUND_TOP + 1, 0, 0, 16, 16, texMisc);
	sprites->Add(ID_SPRITE_GROUND_TOP + 2, 16, 0, 32, 16, texMisc);
	sprites->Add(ID_SPRITE_GROUND_TOP + 3, 32, 0, 48, 16, texMisc);
}
...
void Reload()
{
	...
	// STAR
	CStar* star = new CStar(250.0f, GROUND_Y - 96.0f);
