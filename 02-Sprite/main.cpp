...
void LoadResources()
{
	...
	sprites->Add(10021, 215, 154, 230, 181, texMario);
	...
	// Left
	sprites->Add(40001, 6, 129, 21, 155, texKoopa);
	sprites->Add(40002, 28, 129, 43, 155, texKoopa);
	...
	// Right
	sprites->Add(40011, 545, 129, 560, 155, texKoopa);
	sprites->Add(40012, 567, 129, 582, 155, texKoopa);
	...
	koopa = new CKoopa(50.0f, 50.0f, 0.1f);
}
